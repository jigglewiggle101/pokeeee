import { makeDialogBox } from "../entities/dialog.js";
...
export function makeBattle(p) {
  return {
    ...
    load() {
      ...
      this.npcPokemon.spriteRef = p.loadImage("assets/chimchar.png");
      this.playerPokemon.spriteRef = p.loadImage("assets/fennekinn.png");
    ...
    setup() {
      this.dialogBox.displayText(
        "GO to this gentleman wants to battle !",
        async () => {
